...
function ueberpruefeReihenfolge(eingabe) {
    ...
    const blockRegex = /Block (\d+): (\(DUPLICATE REQUIRED\) )?".+?"?\n*/g;
    let match;
    const bloecke = [];
